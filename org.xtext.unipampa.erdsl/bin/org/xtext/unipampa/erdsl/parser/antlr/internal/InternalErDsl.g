	...
	(
		...
		(
			...
			(
				(
					(
						lv_generalization_2_1='total/disjoint'
						{
						...
						}
						{
						    ...
						    |
						lv_generalization_2_2='total/Overlapped'
						{
						...
						}
						{
						    ...
						    |
						lv_generalization_2_3='partial/disjoint'
						{
						...
						}
						{
						    ...
						    |
						lv_generalization_2_4='partial/overlapped'
						{
