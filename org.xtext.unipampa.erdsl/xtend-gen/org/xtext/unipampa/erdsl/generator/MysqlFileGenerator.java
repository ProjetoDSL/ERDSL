...
public class MysqlFileGenerator extends AbstractGenerator {
  ...
  public void doGenerate(final Resource input, final IFileSystemAccess2 fsa, final IGeneratorContext context) {
    ...
    try {
      ...
      String _plus = (_lowerCase + "_My.sql");
      fsa.generateFile(_plus, this.mysql_CreateModel(modeloER));
  ...
  private CharSequence mysql_CreateModel(final ERModel modeloER) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("-- MySQL Template generated by ERtext\t\t   ");
    _builder.newLine();
    _builder.newLine();
    CharSequence _mysql_DomainMapper = this.mysql_DomainMapper(modeloER);
    _builder.append(_mysql_DomainMapper);
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.newLine();
    CharSequence _mysql_SimpleEntitiesMapper = this.mysql_SimpleEntitiesMapper(modeloER);
    _builder.append(_mysql_SimpleEntitiesMapper);
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    CharSequence _mysql_NToN_DerivedEntitiesMapper = this.mysql_NToN_DerivedEntitiesMapper(modeloER);
    _builder.append(_mysql_NToN_DerivedEntitiesMapper);
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    CharSequence _mysql_TernaryEntitiesMapper = this.mysql_TernaryEntitiesMapper(modeloER);
    _builder.append(_mysql_TernaryEntitiesMapper);
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    CharSequence _mysql_GeneralizationRefMapper = this.mysql_GeneralizationRefMapper(modeloER);
    _builder.append(_mysql_GeneralizationRefMapper);
    _builder.newLineIfNotEmpty();
  ...
  private CharSequence mysql_DomainMapper(final ERModel m) {
    StringConcatenation _builder = new StringConcatenation();
    ...
    String _upperCase_3 = m.getDomain().getName().toString().toUpperCase();
  ...
  private CharSequence mysql_SimpleEntitiesMapper(final ERModel m) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      for(final Entity entity : _entities) {
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        CharSequence _mysql_AttributesMapper = this.mysql_AttributesMapper(m, entity);
        _builder.append(_mysql_AttributesMapper, "\t");
        _builder.newLineIfNotEmpty();
      }
      if (_hasElements) {
        _builder.append(");\n");
  ...
  private CharSequence mysql_AttributesMapper(final ERModel m, final Entity e) {
    StringConcatenation _builder = new StringConcatenation();
    {
      Entity _is = e.getIs();
      ...
      if (_tripleNotEquals) {
        {
          ...
          for(final Attribute PKInherited : _filter) {
            CharSequence _mysql_AttTypeChecker = this.mysql_AttTypeChecker(PKInherited);
            _builder.append(_mysql_AttTypeChecker);
            _builder.newLineIfNotEmpty();
          }
        }
    ...
    }
    {
      ...
      for(final Attribute a : _filter_1) {
        CharSequence _mysql_AttTypeChecker_1 = this.mysql_AttTypeChecker(a);
        _builder.append(_mysql_AttTypeChecker_1);
        _builder.newLineIfNotEmpty();
      }
    }
    ...
    _builder.newLineIfNotEmpty();
    {
      ...
      for(final Attribute a_1 : _filter_2) {
        CharSequence _mysql_AttTypeChecker_2 = this.mysql_AttTypeChecker(a_1);
        _builder.append(_mysql_AttTypeChecker_2);
        _builder.newLineIfNotEmpty();
      }
    }
    CharSequence _mysql_1To1_RefCheck = this.mysql_1To1_RefCheck(m, e);
    _builder.append(_mysql_1To1_RefCheck);
    _builder.newLineIfNotEmpty();
    CharSequence _mysql_1ToN_RefCheck = this.mysql_1ToN_RefCheck(m, e);
    _builder.append(_mysql_1ToN_RefCheck);
    _builder.newLineIfNotEmpty();
    this.mysql_MountPkList(this.primaryKeys, this.inheritedPrimaryKeys);
    _builder.newLineIfNotEmpty();
  ...
  private void mysql_MountPkList(final ArrayList<Entity> pks, final ArrayList<Entity> inheritedPks) {
  ...
  private CharSequence mysql_AttTypeChecker(final Attribute a) {
    StringConcatenation _builder = new StringConcatenation();
    {
              ...
              if (_equalsIgnoreCase_4) {
                ...
                if (_equalsIgnoreCase_5) {
                  ...
                  if (_equalsIgnoreCase_6) {
                    ...
                    _builder.append(" BINARY NOT NULL,");
                    _builder.newLineIfNotEmpty();
                  }
                }
              }
  ...
  private CharSequence mysql_AttTypeChecker_Unnamed(final Attribute a) {
    StringConcatenation _builder = new StringConcatenation();
    {
      boolean _equalsIgnoreCase = a.getType().toString().equalsIgnoreCase("string");
      if (_equalsIgnoreCase) {
  ...
  private CharSequence mysql_1To1_RefCheck(final ERModel m, final Entity e) {
    StringConcatenation _builder = new StringConcatenation();
    {
                              ...
                              if (_tripleNotEquals) {
                                {
                                  ...
                                  for(final Attribute a : _filter) {
                                    ...
                                    CharSequence _mysql_AttTypeChecker = this.mysql_AttTypeChecker(a);
                                    String _plus_1 = (_plus + _mysql_AttTypeChecker);
                                ...
                                Object _xblockexpression = null;
                                {
                                  this.sc_AlterTbl_1to1.append(this.mysql_AlterTable_1to1_1toN_RefMapper(e, e.getIs(), r, Boolean.valueOf(true), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), "[1to1]"));
                                  _xblockexpression = null;
                                }
                                _builder.append(_xblockexpression);
                                _builder.newLineIfNotEmpty();
                                ...
                                if (_tripleEquals) {
                                  {
                                    ...
                                    for(final Attribute a_1 : _filter_1) {
                                      ...
                                      CharSequence _mysql_AttTypeChecker_1 = this.mysql_AttTypeChecker(a_1);
                                      String _plus_3 = (_plus_2 + _mysql_AttTypeChecker_1);
                                  ...
                                  Object _xblockexpression_1 = null;
                                  {
                                    this.sc_AlterTbl_1to1.append(this.mysql_AlterTable_1to1_1toN_RefMapper(e, eAux, r, Boolean.valueOf(false), Boolean.valueOf(true), Boolean.valueOf(false), Boolean.valueOf(false), "[1to1]"));
                                    _xblockexpression_1 = null;
                                  }
                                  _builder.append(_xblockexpression_1);
                                  _builder.newLineIfNotEmpty();
                                ...
                                if (_tripleNotEquals_1) {
                                  {
                                    ...
                                    for(final Attribute a_2 : _filter_2) {
                                      ...
                                      CharSequence _mysql_AttTypeChecker_2 = this.mysql_AttTypeChecker(a_2);
                                      String _plus_5 = (_plus_4 + _mysql_AttTypeChecker_2);
                                  ...
                                  Object _xblockexpression_2 = null;
                                  {
                                    this.sc_AlterTbl_1to1.append(this.mysql_AlterTable_1to1_1toN_RefMapper(e, eAux, r, Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(true), Boolean.valueOf(false), "[1to1]"));
                                    _xblockexpression_2 = null;
                                  }
                                  _builder.append(_xblockexpression_2);
                                  _builder.newLineIfNotEmpty();
                                  ...
                                  if (_tripleEquals_1) {
                                    {
                                      ...
                                      for(final Attribute a_3 : _filter_3) {
                                        ...
                                        CharSequence _mysql_AttTypeChecker_3 = this.mysql_AttTypeChecker(a_3);
                                        String _plus_7 = (_plus_6 + _mysql_AttTypeChecker_3);
                                    ...
                                    Object _xblockexpression_3 = null;
                                    {
                                      this.sc_AlterTbl_1to1.append(this.mysql_AlterTable_1to1_1toN_RefMapper(e, eAux, r, Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(true), "[1to1]"));
                                      _xblockexpression_3 = null;
                                    }
                                    _builder.append(_xblockexpression_3);
                                    _builder.newLineIfNotEmpty();
  ...
  private CharSequence mysql_1ToN_RefCheck(final ERModel m, final Entity e) {
    StringConcatenation _builder = new StringConcatenation();
    {
                      ...
                      if (_equalsIgnoreCase_2) {
                        {
                          ...
                          if (_tripleNotEquals) {
                            ...
                            Object _xblockexpression = null;
                            {
                              this.sc_AlterTbl_1toN.append(this.mysql_AlterTable_1to1_1toN_RefMapper(e, e.getIs(), r, Boolean.valueOf(true), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), "[1toN]"));
                              _xblockexpression = null;
                            }
                            _builder.append(_xblockexpression);
                            _builder.newLineIfNotEmpty();
                            ...
                            if (_tripleEquals) {
                              ...
                              Object _xblockexpression_1 = null;
                              {
                                this.sc_AlterTbl_1toN.append(this.mysql_AlterTable_1to1_1toN_RefMapper(e, eAux, r, Boolean.valueOf(false), Boolean.valueOf(true), Boolean.valueOf(false), Boolean.valueOf(false), "[1toN]"));
                                _xblockexpression_1 = null;
                              }
                              _builder.append(_xblockexpression_1);
                              _builder.newLineIfNotEmpty();
                        ...
                        if (_not) {
                          {
                            ...
                            if (_tripleNotEquals_1) {
                              ...
                              Object _xblockexpression_2 = null;
                              {
                                this.sc_AlterTbl_1toN.append(this.mysql_AlterTable_1to1_1toN_RefMapper(e, eAux, r, Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(true), Boolean.valueOf(false), "[1toN]"));
                                _xblockexpression_2 = null;
                              }
                              _builder.append(_xblockexpression_2);
                              _builder.newLineIfNotEmpty();
                              ...
                              if (_tripleEquals_1) {
                                ...
                                Object _xblockexpression_3 = null;
                                {
                                  this.sc_AlterTbl_1toN.append(this.mysql_AlterTable_1to1_1toN_RefMapper(e, eAux, r, Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(true), "[1toN]"));
                                  _xblockexpression_3 = null;
                                }
                                _builder.append(_xblockexpression_3);
                                _builder.newLineIfNotEmpty();
                          ...
                          if (_tripleNotEquals_2) {
                            {
                              ...
                              for(final Attribute a_4 : _filter_6) {
                                ...
                                CharSequence _mysql_AttTypeChecker_4 = this.mysql_AttTypeChecker(a_4);
                                String _plus_9 = (_plus_8 + _mysql_AttTypeChecker_4);
                            ...
                            Object _xblockexpression_4 = null;
                            {
                              this.sc_AlterTbl_1toN.append(this.mysql_AlterTable_1to1_1toN_RefMapper(e, e.getIs(), r_1, Boolean.valueOf(true), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), "[Nto1]"));
                              _xblockexpression_4 = null;
                            }
                            _builder.append(_xblockexpression_4, "\t");
                            _builder.newLineIfNotEmpty();
                            ...
                            if (_tripleEquals_2) {
                              {
                                ...
                                for(final Attribute a_5 : _filter_7) {
                                  ...
                                  CharSequence _mysql_AttTypeChecker_5 = this.mysql_AttTypeChecker(a_5);
                                  String _plus_11 = (_plus_10 + _mysql_AttTypeChecker_5);
                              ...
                              {
                                this.sc_AlterTbl_1toN.append(this.mysql_AlterTable_1to1_1toN_RefMapper(e, eAux_1, r_1, Boolean.valueOf(false), Boolean.valueOf(true), Boolean.valueOf(false), Boolean.valueOf(false), "[Nto1]"));
                            ...
                            if (_tripleNotEquals_3) {
                              {
                                ...
                                for(final Attribute a_6 : _filter_8) {
                                  ...
                                  CharSequence _mysql_AttTypeChecker_6 = this.mysql_AttTypeChecker(a_6);
                                  String _plus_13 = (_plus_12 + _mysql_AttTypeChecker_6);
                              ...
                              {
                                this.sc_AlterTbl_1toN.append(this.mysql_AlterTable_1to1_1toN_RefMapper(e, eAux_1, r_1, Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(true), Boolean.valueOf(false), "[Nto1]"));
                              ...
                              if (_tripleEquals_3) {
                                {
                                  ...
                                  for(final Attribute a_7 : _filter_9) {
                                    ...
                                    CharSequence _mysql_AttTypeChecker_7 = this.mysql_AttTypeChecker(a_7);
                                    String _plus_15 = (_plus_14 + _mysql_AttTypeChecker_7);
                                ...
                                {
                                  this.sc_AlterTbl_1toN.append(this.mysql_AlterTable_1to1_1toN_RefMapper(e, eAux_1, r_1, Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(true), "[Nto1]"));
  ...
  private CharSequence mysql_NToN_DerivedEntitiesMapper(final ERModel m) {
    StringConcatenation _builder = new StringConcatenation();
    {
      final Function1<Relation, Boolean> _function = (Relation it) -> {
        return Boolean.valueOf(((((it.getLeftEnding().getCardinality().equalsIgnoreCase("(0:N)") || it.getLeftEnding().getCardinality().equalsIgnoreCase("(1:N)")) && (it.getRightEnding().getCardinality().equalsIgnoreCase("(0:N)") || it.getRightEnding().getCardinality().equalsIgnoreCase("(1:N)"))) && (it.getLeftEnding().getTarget() instanceof Entity)) && (it.getRightEnding().getTarget() instanceof Entity)));
      ...
      for(final Relation r : _filter) {
              ...
              if (_tripleNotEquals) {
                {
                  ...
                  for(final Attribute a_1 : _filter_2) {
                    ...
                    CharSequence _mysql_AttTypeChecker_1 = this.mysql_AttTypeChecker(a_1);
                    String _plus_1 = (_plus + _mysql_AttTypeChecker_1);
                    _builder.append(_plus_1, "\t");
                    _builder.newLineIfNotEmpty();
                    Object _xblockexpression_1 = null;
                    {
                ...
                Object _xblockexpression_2 = null;
                {
                  this.sc_AlterTbl_NtoN.append(this.mysql_AlterTable_NtoN_RefMapper(leftEnt, rightEnt, r, Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(true), Boolean.valueOf(false), "[NtoN]"));
                  _xblockexpression_2 = null;
                }
                _builder.append(_xblockexpression_2);
                _builder.newLineIfNotEmpty();
                ...
                if (_tripleEquals) {
                  {
                    ...
                    for(final Attribute a_2 : _filter_3) {
                      ...
                      String _plus_2 = (_lowerCase_2 + "_");
                      CharSequence _mysql_AttTypeChecker_2 = this.mysql_AttTypeChecker(a_2);
                      String _plus_3 = (_plus_2 + _mysql_AttTypeChecker_2);
                      _builder.append(_plus_3, "\t");
                      _builder.newLineIfNotEmpty();
                      Object _xblockexpression_3 = null;
                      {
                  ...
                  Object _xblockexpression_4 = null;
                  {
                    this.sc_AlterTbl_NtoN.append(this.mysql_AlterTable_NtoN_RefMapper(leftEnt, rightEnt, r, Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(true), "[NtoN]"));
                    _xblockexpression_4 = null;
                  }
                  _builder.append(_xblockexpression_4);
                  _builder.newLineIfNotEmpty();
              ...
              if (_tripleNotEquals_1) {
                {
                  ...
                  for(final Attribute a_3 : _filter_4) {
                    ...
                    String _plus_4 = (_lowerCase_3 + "_");
                    CharSequence _mysql_AttTypeChecker_3 = this.mysql_AttTypeChecker(a_3);
                    String _plus_5 = (_plus_4 + _mysql_AttTypeChecker_3);
                    _builder.append(_plus_5, "\t");
                    _builder.newLineIfNotEmpty();
                    Object _xblockexpression_5 = null;
                    {
                ...
                Object _xblockexpression_6 = null;
                {
                  this.sc_AlterTbl_NtoN.append(this.mysql_AlterTable_NtoN_RefMapper(rightEnt, leftEnt, r, Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(true), Boolean.valueOf(false), "[NtoN]"));
                  _xblockexpression_6 = null;
                }
                _builder.append(_xblockexpression_6);
                _builder.newLineIfNotEmpty();
                ...
                if (_tripleEquals_1) {
                  {
                    ...
                    for(final Attribute a_4 : _filter_5) {
                      ...
                      String _plus_6 = (_lowerCase_4 + "_");
                      CharSequence _mysql_AttTypeChecker_4 = this.mysql_AttTypeChecker(a_4);
                      String _plus_7 = (_plus_6 + _mysql_AttTypeChecker_4);
                      _builder.append(_plus_7, "\t");
                      _builder.newLineIfNotEmpty();
                      Object _xblockexpression_7 = null;
                      {
                  ...
                  {
                    this.sc_AlterTbl_NtoN.append(this.mysql_AlterTable_NtoN_RefMapper(rightEnt, leftEnt, r, Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(true), "[NtoN]"));
                ...
                if (_tripleNotEquals_2) {
                  {
                    ...
                    for(final Attribute a_5 : _filter_6) {
                      ...
                      CharSequence _mysql_AttTypeChecker_Unnamed = this.mysql_AttTypeChecker_Unnamed(a_5);
                      String _plus_11 = (_plus_10 + _mysql_AttTypeChecker_Unnamed);
                      _builder.append(_plus_11, "\t");
                      _builder.newLineIfNotEmpty();
                  ...
                  {
                    this.sc_AlterTbl_NtoN.append(this.mysql_AlterTable_NtoN_RefMapper(leftEnt, rightEnt, r, Boolean.valueOf(true), Boolean.valueOf(false), Boolean.valueOf(false), Boolean.valueOf(false), "[NtoN]"));
                  ...
                  if (_tripleEquals_2) {
                    {
                      ...
                      for(final Attribute a_6 : _filter_7) {
                        ...
                        String _plus_13 = (_plus_12 + _lowerCase_8);
                        String _plus_14 = (_plus_13 + "_1");
                        CharSequence _mysql_AttTypeChecker_Unnamed_1 = this.mysql_AttTypeChecker_Unnamed(a_6);
                        String _plus_15 = (_plus_14 + _mysql_AttTypeChecker_Unnamed_1);
                        _builder.append(_plus_15, "\t");
                        _builder.newLineIfNotEmpty();
                    ...
                    {
                      this.sc_AlterTbl_NtoN.append(this.mysql_AlterTable_NtoN_RefMapper(leftEnt, rightEnt, r, Boolean.valueOf(false), Boolean.valueOf(true), Boolean.valueOf(false), Boolean.valueOf(false), "[NtoN]"));
                ...
                if (_tripleNotEquals_3) {
                  {
                    ...
                    for(final Attribute a_7 : _filter_8) {
                      ...
                      CharSequence _mysql_AttTypeChecker_Unnamed_2 = this.mysql_AttTypeChecker_Unnamed(a_7);
                      String _plus_19 = (_plus_18 + _mysql_AttTypeChecker_Unnamed_2);
                  ...
                  if (_tripleEquals_3) {
                    {
                      ...
                      for(final Attribute a_8 : _filter_9) {
                        ...
                        String _plus_21 = (_plus_20 + _lowerCase_12);
                        String _plus_22 = (_plus_21 + "_2");
                        CharSequence _mysql_AttTypeChecker_Unnamed_3 = this.mysql_AttTypeChecker_Unnamed(a_8);
                        String _plus_23 = (_plus_22 + _mysql_AttTypeChecker_Unnamed_3);
        ...
        }
        {
          ...
          for(final Attribute a_9 : _filter_10) {
            _builder.append("\t");
            CharSequence _mysql_AttTypeChecker_5 = this.mysql_AttTypeChecker(a_9);
            _builder.append(_mysql_AttTypeChecker_5);
          }
        }
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
  ...
  private CharSequence mysql_TernaryEntitiesMapper(final ERModel model) {
    StringConcatenation _builder = new StringConcatenation();
    {
      ...
      for(final Relation r : _filter) {
        ...
        _builder.newLineIfNotEmpty();
        {
          ...
          for(final Attribute att : _filter_1) {
            ...
            String _plus = (_lowerCase_1 + "_");
            CharSequence _mysql_AttTypeChecker = this.mysql_AttTypeChecker(att);
            String _plus_1 = (_plus + _mysql_AttTypeChecker);
            _builder.append(_plus_1);
            _builder.newLineIfNotEmpty();
          }
        }
        {
          ...
          for(final Attribute att_1 : _filter_2) {
            ...
            String _plus_2 = (_lowerCase_2 + "_");
            CharSequence _mysql_AttTypeChecker_1 = this.mysql_AttTypeChecker(att_1);
            String _plus_3 = (_plus_2 + _mysql_AttTypeChecker_1);
            _builder.append(_plus_3);
            _builder.newLineIfNotEmpty();
          }
        }
        {
          ...
          for(final Attribute att_2 : _filter_3) {
            ...
            String _plus_4 = (_lowerCase_3 + "_");
            CharSequence _mysql_AttTypeChecker_2 = this.mysql_AttTypeChecker(att_2);
            String _plus_5 = (_plus_4 + _mysql_AttTypeChecker_2);
            _builder.append(_plus_5);
            _builder.newLineIfNotEmpty();
          }
          ...
          if (_tripleNotEquals) {
            {
              ...
              for(final Attribute att_3 : _attributes_1) {
                _builder.append("\t");
                CharSequence _mysql_AttTypeChecker_3 = this.mysql_AttTypeChecker(att_3);
                _builder.append(_mysql_AttTypeChecker_3);
                {
        ...
        Object _xblockexpression_11 = null;
        {
          this.sc_AlterTbl_1toN.append(this.mysql_AlterTable_Ternary_RefMapper(r.getName(), auxEnt.getName(), auxRel.getName(), auxLeftEntity.getName(), auxRightEntity.getName(), this.mapTernary));
          _xblockexpression_11 = null;
        }
        _builder.append(_xblockexpression_11, "\t");
        Object _xblockexpression_12 = null;
      ...
      for(final Relation r_1 : _filter_7) {
        ...
        _builder.newLineIfNotEmpty();
        {
          ...
          for(final Attribute att_7 : _filter_8) {
            ...
            CharSequence _mysql_AttTypeChecker_4 = this.mysql_AttTypeChecker(att_7);
            String _plus_7 = (_plus_6 + _mysql_AttTypeChecker_4);
            _builder.append(_plus_7);
            _builder.newLineIfNotEmpty();
          }
        }
        {
          ...
          for(final Attribute att_8 : _filter_9) {
            ...
            CharSequence _mysql_AttTypeChecker_5 = this.mysql_AttTypeChecker(att_8);
            String _plus_9 = (_plus_8 + _mysql_AttTypeChecker_5);
            _builder.append(_plus_9);
            _builder.newLineIfNotEmpty();
          }
        }
        {
          ...
          for(final Attribute att_9 : _filter_10) {
            ...
            CharSequence _mysql_AttTypeChecker_6 = this.mysql_AttTypeChecker(att_9);
            String _plus_11 = (_plus_10 + _mysql_AttTypeChecker_6);
            _builder.append(_plus_11);
            _builder.newLineIfNotEmpty();
          }
        }
          ...
          if (_tripleNotEquals_1) {
            {
              ...
              for(final Attribute att_10 : _attributes_3) {
                _builder.append("\t");
                CharSequence _mysql_AttTypeChecker_7 = this.mysql_AttTypeChecker(att_10);
                _builder.append(_mysql_AttTypeChecker_7);
                {
        ...
        {
          this.sc_AlterTbl_1toN.append(this.mysql_AlterTable_Ternary_RefMapper(r_1.getName(), auxEnt_1.getName(), auxRel_1.getName(), auxLeftEntity_1.getName(), auxRightEntity_1.getName(), this.mapTernary));
  ...
  private CharSequence mysql_GeneralizationRefMapper(final ERModel m) {
    StringConcatenation _builder = new StringConcatenation();
    {
  ...
  private CharSequence mysql_AlterTable_1to1_1toN_RefMapper(final Entity alterTbl, final Entity refTbl, final Relation r, final Boolean selfRelWithGen, final Boolean selfRelNoGen, final Boolean relWithOneGen, final Boolean relNoGen, final String cardinalityRel) {
    StringConcatenation _builder = new StringConcatenation();
    {
  ...
  private CharSequence mysql_AlterTable_NtoN_RefMapper(final Entity leftEnt, final Entity rightEnt, final Relation r, final Boolean selfRelWithGen, final Boolean selfRelNoGen, final Boolean relWithOneGen, final Boolean relNoGen, final String cardinalityRel) {
    StringConcatenation _builder = new StringConcatenation();
    {
      if ((selfRelWithGen).booleanValue()) {
        _builder.append("-- ");
  ...
  private CharSequence mysql_AlterTable_Ternary_RefMapper(final String tabelaTernaria, final String tabelaEntidade, final String nomeRelacaoNN, final String leftNN, final String rightNN, final HashMap keysMap) {
    StringConcatenation _builder = new StringConcatenation();
