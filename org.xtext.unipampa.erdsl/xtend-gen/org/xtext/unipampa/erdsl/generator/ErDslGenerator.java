...
public class ErDslGenerator extends AbstractGenerator {
      ...
      if (((!StringExtensions.isNullOrEmpty(modeloER.getTargetGenerator())) && modeloER.getTargetGenerator().equalsIgnoreCase("postgresql"))) {
        ...
        if (((!StringExtensions.isNullOrEmpty(modeloER.getTargetGenerator())) && modeloER.getTargetGenerator().equalsIgnoreCase("mysql"))) {
          ...
          if ((StringExtensions.isNullOrEmpty(modeloER.getTargetGenerator()) || modeloER.getTargetGenerator().equalsIgnoreCase("all"))) {
            ...
            fsa.generateFile(_plus_9, this.CreatePostgreSQL(modeloER));
  ...
  private CharSequence CreatePostgreSQL(final ERModel e) {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("/* TEMPLATE GENERATED BY ERtext */");
    _builder.newLine();
    _builder.newLine();
    ...
    _builder.newLine();
    {
      ...
      for(final Entity entity : _entities) {
                      ...
                      for(final Attribute auxAttributes : _attributes) {
                        {
                          ...
                          if (_isIsKey) {
                            _builder.append("\t");
                            CharSequence _attTypeCheckerPG = this.attTypeCheckerPG(auxAttributes);
                            _builder.append(_attTypeCheckerPG, "\t");
                            _builder.newLineIfNotEmpty();
                          }
                        }
                      }
        ...
        _builder.append("\t");
        {
          EList<Attribute> _attributes_1 = entity.getAttributes();
          for(final Attribute attribute : _attributes_1) {
            CharSequence _attTypeCheckerPG_1 = this.attTypeCheckerPG(attribute);
            _builder.append(_attTypeCheckerPG_1, "\t");
          }
        }
        _builder.newLineIfNotEmpty();
        {
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        CharSequence _verifyFKsAttributesRelation1to1 = this.verifyFKsAttributesRelation1to1(e, entity.getName());
        _builder.append(_verifyFKsAttributesRelation1to1, "\t");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        CharSequence _verifyFKsAttributesRelation1toN = this.verifyFKsAttributesRelation1toN(e, entity.getName());
        _builder.append(_verifyFKsAttributesRelation1toN, "\t");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        ...
        {
          boolean _isNullOrEmpty = IterableExtensions.isNullOrEmpty(myListExtendPKs);
        ...
        _builder.append("\t");
        {
          ...
          for(final Object x_1 : myListExtendPKs) {
            ...
            CharSequence _discoverInheritedPKtoFK = this.discoverInheritedPKtoFK(e, x_1.toString());
            _builder.append(_discoverInheritedPKtoFK, "\t");
          }
        }
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        CharSequence _defineFKsRelation1to1 = this.defineFKsRelation1to1(e, entity.getName());
        _builder.append(_defineFKsRelation1to1, "\t");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        CharSequence _defineFKsRelation1toN = this.defineFKsRelation1toN(e, entity.getName());
        _builder.append(_defineFKsRelation1toN, "\t");
        _builder.newLineIfNotEmpty();
      }
      if (_hasElements) {
        _builder.append(");\n");
          ...
          if (((relation.getLeftEnding().getCardinality().equalsIgnoreCase("(0:N)") || relation.getLeftEnding().getCardinality().equalsIgnoreCase("(1:N)")) && (relation.getRightEnding().getCardinality().equalsIgnoreCase("(0:N)") || relation.getRightEnding().getCardinality().equalsIgnoreCase("(1:N)")))) {
            {
              ...
              if (_isNullOrEmpty_1) {
                String _upperCase_5 = relation.getLeftEnding().getTarget().toString().toUpperCase();
                _builder.append(_upperCase_5);
                _builder.newLineIfNotEmpty();
                _builder.newLine();
                _builder.append("-- Table: ");
                String _upperCase_6 = relation.getRightEnding().getTarget().toString().toUpperCase();
                _builder.append(_upperCase_6);
                _builder.newLineIfNotEmpty();
                _builder.append("-- DROP TABLE ");
                String _upperCase_7 = relation.getRightEnding().getTarget().toString().toUpperCase();
                _builder.append(_upperCase_7);
                _builder.append(";");
                _builder.newLineIfNotEmpty();
                _builder.append("CREATE TABLE IF NOT EXISTS ");
                ...
                if (_not_3) {
                  _builder.newLine();
                  _builder.append("-- Table: ");
                  String _upperCase_9 = relation.getName().toUpperCase();
                  _builder.append(_upperCase_9);
                  _builder.newLineIfNotEmpty();
                  _builder.append("-- DROP TABLE ");
                  String _upperCase_10 = relation.getName().toUpperCase();
                  _builder.append(_upperCase_10);
                  _builder.append(";");
                  _builder.newLineIfNotEmpty();
                  _builder.append("CREATE TABLE IF NOT EXISTS ");
              ...
              for(final Entity entity_1 : _entities_3) {
                {
                  if ((relation.getLeftEnding().getTarget().toString().equalsIgnoreCase(entity_1.getName()) && (relation.getLeftEnding().getTarget().toString() != relation.getRightEnding().getTarget().toString()))) {
                    ...
                    CharSequence _attTypeCheckerNtoNLeft = this.attTypeCheckerNtoNLeft(e, relation);
                    _builder.append(_attTypeCheckerNtoNLeft);
                  }
                }
                _builder.newLineIfNotEmpty();
                {
                  if ((relation.getRightEnding().getTarget().toString().equalsIgnoreCase(entity_1.getName()) && (relation.getRightEnding().getTarget().toString() != relation.getLeftEnding().getTarget().toString()))) {
                    ...
                    CharSequence _attTypeCheckerNtoNRight = this.attTypeCheckerNtoNRight(e, relation);
                    _builder.append(_attTypeCheckerNtoNRight);
                  }
                }
                _builder.newLineIfNotEmpty();
              }
              ...
              if (_not_4) {
                {
                  ...
                  for(final Attribute aux_2 : _attributes_4) {
                    CharSequence _attTypeCheckerPG_2 = this.attTypeCheckerPG(aux_2);
                    _builder.append(_attTypeCheckerPG_2, "\t");
                  }
                }
                _builder.newLineIfNotEmpty();
              }
              ...
              for(final Attribute aux_3 : _attributes_5) {
                {
                  ...
                  if (_isIsKey_3) {
                    String _lowerCase_4 = aux_3.getName().toString().toLowerCase();
            ...
            _builder.append("\t");
            {
              ...
              for(final String x_3 : myListPKsFKs) {
                ...
                _builder.append(" (");
                CharSequence _discoverPKtoFK = this.discoverPKtoFK(e, x_3);
                _builder.append(_discoverPKtoFK, "\t");
              }
            }
            _builder.append(")");
            myListPKsFKs.clear();
  ...
  private CharSequence attTypeCheckerPG(final Attribute a) {
    StringConcatenation _builder = new StringConcatenation();
  ...
  private CharSequence attTypeCheckerNtoNLeft(final ERModel e, final Relation r) {
    StringConcatenation _builder = new StringConcatenation();
    {
      EList<Entity> _entities = e.getEntities();
  ...
  private CharSequence attTypeCheckerNtoNRight(final ERModel e, final Relation r) {
    StringConcatenation _builder = new StringConcatenation();
    {
      EList<Entity> _entities = e.getEntities();
      for(final Entity aux : _entities) {
  ...
  private CharSequence discoverPKtoFK(final ERModel e, final String r) {
    StringConcatenation _builder = new StringConcatenation();
    {
      EList<Entity> _entities = e.getEntities();
      for(final Entity aux : _entities) {
  ...
  private CharSequence discoverInheritedPKtoFK(final ERModel e, final String r) {
    StringConcatenation _builder = new StringConcatenation();
    {
      EList<Entity> _entities = e.getEntities();
      for(final Entity aux : _entities) {
  ...
  private CharSequence verifyFKsAttributesRelation1to1(final ERModel e, final String ename) {
    StringConcatenation _builder = new StringConcatenation();
    {
      EList<Relation> _relations = e.getRelations();
      for(final Relation relation : _relations) {
                      ...
                      if (_equalsIgnoreCase_1) {
                        {
                          ...
                          if (_tripleEquals) {
                              ...
                              for(final Attribute aux2 : _attributes) {
                                {
                                  ...
                                  if (_isIsKey) {
                                    _builder.append("!!! FK1 !!! ");
                                    CharSequence _attTypeCheckerPG = this.attTypeCheckerPG(aux2);
                                    _builder.append(_attTypeCheckerPG);
                                    _builder.append(" ");
                                    _builder.newLineIfNotEmpty();
                                  }
                            ...
                            if (_not) {
                              _builder.append("!!! FK2 !!! ");
                              String _string = aux.getIs().toString();
                              _builder.append(_string);
                              _builder.newLineIfNotEmpty();
                            }
                          }
  ...
  private CharSequence verifyFKsAttributesRelation1toN(final ERModel e, final String ename) {
    StringConcatenation _builder = new StringConcatenation();
    {
      EList<Relation> _relations = e.getRelations();
      for(final Relation relation : _relations) {
                              ...
                              for(final Attribute attTest : _attributes) {
                                {
                                  ...
                                  if (_isIsKey) {
                                    _builder.append("!!! FK3 !!! ");
                                    CharSequence _attTypeCheckerPG = this.attTypeCheckerPG(attTest);
                                    _builder.append(_attTypeCheckerPG);
                                    _builder.append(" ");
                                    _builder.newLineIfNotEmpty();
                                  }
  ...
  private CharSequence defineFKsRelation1to1(final ERModel e, final String ename) {
    StringConcatenation _builder = new StringConcatenation();
    {
      EList<Relation> _relations = e.getRelations();
      for(final Relation relation : _relations) {
                      ...
                      if (_equalsIgnoreCase_1) {
                        {
                          ...
                          if (_tripleEquals) {
                            ...
                            if (_not) {
                              ...
                              String _string_1 = aux.getIs().toString();
                              _builder.append(_string_1);
                              _builder.append(" !!! FK2 !!!");
                              _builder.newLineIfNotEmpty();
                            }
  ...
  private CharSequence defineFKsRelation1toN(final ERModel e, final String ename) {
    StringConcatenation _builder = new StringConcatenation();
    {
      EList<Relation> _relations = e.getRelations();
      for(final Relation relation : _relations) {
  ...
  private CharSequence attributeIdentifierCheckerPG(final Attribute a) {
    StringConcatenation _builder = new StringConcatenation();
    {
