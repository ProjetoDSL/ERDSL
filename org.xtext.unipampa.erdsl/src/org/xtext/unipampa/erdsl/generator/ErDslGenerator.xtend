					...
					«FOR aux : e.entities»
						«IF relation.leftEnding.target.toString.equalsIgnoreCase(aux.name)»
							«IF aux.is === null»
								«FOR attTest : aux.attributes»
									«IF attTest.isIsKey»
											FOREIGN KEY («attTest.name.toString.toLowerCase») REFERENCES «aux.name.toString» («attTest.name.toString.toLowerCase»)«IF counter > 1»,«{counter -= 1;null}»«ENDIF»
									«ENDIF»
								«ENDFOR»
							«ELSEIF !(aux.is === null)»
								«IF relation.leftEnding.target.toString.equalsIgnoreCase(relation.rightEnding.target.toString)»
									FOREIGN KEY («relation.name.toString.toLowerCase») REFERENCES «relation.leftEnding.target.toString.toLowerCase» («FOR aux2 : e.entities»«IF aux2.name.equalsIgnoreCase(relation.leftEnding.target.toString)»«FOR aux3 : e.entities»«IF aux3.name.equalsIgnoreCase(aux2.is.toString)»«FOR aux4 : aux3.attributes»«IF aux4.isIsKey»«aux4.name.toString.toLowerCase»)«IF counter > 1»,«{counter -= 1;null}»«ENDIF»«ENDIF»«ENDFOR»«ENDIF»«ENDFOR»«ENDIF»«ENDFOR»
								«ELSEIF !relation.leftEnding.target.toString.equalsIgnoreCase(relation.rightEnding.target.toString)»
								FOREIGN KEY («relation.leftEnding.target.toString.toLowerCase») REFERENCES «relation.leftEnding.target.toString.toLowerCase» («FOR aux2 : e.entities»«IF aux2.name.equalsIgnoreCase(relation.leftEnding.target.toString)»«FOR aux3 : e.entities»«IF aux3.name.equalsIgnoreCase(aux2.is.toString)»«FOR aux4 : aux3.attributes»«IF aux4.isIsKey»«aux4.name.toString.toLowerCase»)«IF counter > 1»,«{counter -= 1;null}»«ENDIF»«ENDIF»«ENDFOR»«ENDIF»«ENDFOR»«ENDIF»«ENDFOR»
							«ENDIF»
						«ENDIF»
						«ENDIF»
					«ENDFOR»
