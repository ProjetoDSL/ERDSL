...
class ErDslGenerator extends AbstractGenerator {
	...
	«FOR entity : e.entities SEPARATOR "\n);\n" AFTER ");\n"»
		...
		(
		«FOR attribute : entity.attributes»«attributeTypeCheck(attribute)»«ENDFOR»
		PRIMARY KEY («FOR attribute : entity.attributes»«IF attribute.isIsKey»«attribute.name.toString»«ENDIF»«ENDFOR»)
	«ENDFOR»
	'''
	...
	private def attributeIdentifierCheck(Attribute a) '''
