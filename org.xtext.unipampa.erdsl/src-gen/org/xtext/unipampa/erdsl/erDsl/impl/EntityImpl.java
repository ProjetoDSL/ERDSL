 ...
 *   <li>{@link org.xtext.unipampa.erdsl.erDsl.impl.EntityImpl#getGeneralization <em>Generalization</em>}</li>
...
public class EntityImpl extends MinimalEObjectImpl.Container implements Entity
{
  ...
  public void setGeneralization(String newGeneralization)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ErDslPackage.ENTITY__GENERALIZATION, oldGeneralization, generalization));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ErDslPackage.ENTITY__NAME:
        return getName();
      case ErDslPackage.ENTITY__GENERALIZATION:
