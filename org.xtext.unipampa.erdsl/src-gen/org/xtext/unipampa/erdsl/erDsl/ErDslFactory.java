...
public interface ErDslFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Relation Side Right</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Relation Side Right</em>'.
   * @generated
   */
  RelationSideRight createRelationSideRight();

  /**
   * Returns a new object of class '<em>Relation Side Left</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Relation Side Left</em>'.
   * @generated
   */
  RelationSideLeft createRelationSideLeft();
