...
@Singleton
public class ErDsl2GrammarAccess extends AbstractGrammarElementFinder {
	
	public class ERModelElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.ErDsl2.ERModel");
		...
		private final Keyword cRelationshipsKeyword_4 = (Keyword)cGroup.eContents().get(4);
		...
		//'Relationships{'
		public Keyword getRelationshipsKeyword_4() { return cRelationshipsKeyword_4; }
	...
	public class DomainElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.ErDsl2.Domain");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AttributeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.ErDsl2.Attribute");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cIsKeyAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Keyword cIsKeyAsteriskKeyword_0_0 = (Keyword)cIsKeyAssignment_0.eContents().get(0);
		private final Assignment cNameAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cNameIDTerminalRuleCall_1_0 = (RuleCall)cNameAssignment_1.eContents().get(0);
		...
		//isKey?='*'?
		public Assignment getIsKeyAssignment_0() { return cIsKeyAssignment_0; }
		
		//'*'
		public Keyword getIsKeyAsteriskKeyword_0_0() { return cIsKeyAsteriskKeyword_0_0; }
	...
	public class EntityElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.ErDsl2.Entity");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//Entity:
		//	name=ID ('is' isA+=[Entity])* ('{' attributes+=Attribute (',' attributes+=Attribute)* '}')?;
		@Override public ParserRule getRule() { return rule; }
	...
	public class RelationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.ErDsl2.Relation");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cNameAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final RuleCall cNameIDTerminalRuleCall_0_0 = (RuleCall)cNameAssignment_0.eContents().get(0);
		private final Group cGroup_1 = (Group)cGroup.eContents().get(1);
	...
	public class RelationSideElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.ErDsl2.RelationSide");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Assignment cCardinalityAssignment_0 = (Assignment)cGroup.eContents().get(0);
		private final Alternatives cCardinalityAlternatives_0_0 = (Alternatives)cCardinalityAssignment_0.eContents().get(0);
		private final Keyword cCardinality01Keyword_0_0_0 = (Keyword)cCardinalityAlternatives_0_0.eContents().get(0);
		private final Keyword cCardinality11Keyword_0_0_1 = (Keyword)cCardinalityAlternatives_0_0.eContents().get(1);
		private final Keyword cCardinality0NKeyword_0_0_2 = (Keyword)cCardinalityAlternatives_0_0.eContents().get(2);
		private final Keyword cCardinality1NKeyword_0_0_3 = (Keyword)cCardinalityAlternatives_0_0.eContents().get(3);
		...
		//('(0,1)' | '(1,1)' | '(0,N)' | '(1,N)')
		public Alternatives getCardinalityAlternatives_0_0() { return cCardinalityAlternatives_0_0; }
		
		//'(0,1)'
		public Keyword getCardinality01Keyword_0_0_0() { return cCardinality01Keyword_0_0_0; }
		
		//'(1,1)'
		public Keyword getCardinality11Keyword_0_0_1() { return cCardinality11Keyword_0_0_1; }
		
		//'(0,N)'
		public Keyword getCardinality0NKeyword_0_0_2() { return cCardinality0NKeyword_0_0_2; }
		
		//'(1,N)'
		public Keyword getCardinality1NKeyword_0_0_3() { return cCardinality1NKeyword_0_0_3; }
	...
	public class DataTypeElements extends AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.ErDsl2.DataType");
	...
	@Inject
	public ErDsl2GrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.xtext.example.ErDsl2".equals(grammar.getName())) {
				return grammar;
			}
